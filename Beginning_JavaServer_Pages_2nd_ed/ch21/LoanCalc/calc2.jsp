...
<html>
    ...
    <br/><br/>
    If the Amount button is selected then the application shows the amount of money
    that can be borrowed when making the specified payment each month for the specified 
    number of months at the set interest rate.
    <hr/>
    <f:view>
        <h:form id="LoanForm">
            <table border='0' >
            ...
            <br/>
            <h:commandButton action="#{LoanBean.amount}" value="Amount" id="AmountId" />
            <h:commandButton action="#{LoanBean.payment}" value="Payment" id="PaymentId" />
            <br/>
            <h:messages />
        </h:form>
    </f:view>
