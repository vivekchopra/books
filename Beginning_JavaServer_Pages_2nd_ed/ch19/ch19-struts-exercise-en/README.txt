...
C:\ch19-struts-exercise-en

2. Modify the C:\ch19-struts-exercise-en\build.xml file as follows:
...
6. The application should now be available for browsing at http://localhost:8080/struts-exercise-en
