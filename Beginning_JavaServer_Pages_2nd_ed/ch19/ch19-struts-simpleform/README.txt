...
C:\ch19-struts-simpleform

2. Modify the C:\ch19-struts-simpleform\build.xml file as follows:
...
6. The application should now be available for browsing at http://localhost:8080/struts-simpleform
